...
public class ViewAllSales extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        salesInfo = new javax.swing.JTable();
        ...
        salesInfo.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
        ...
        jScrollPane1.setViewportView(salesInfo);

        jLabel1.setFont(new java.awt.Font("Tahoma", 1, 36)); // NOI18N
        jLabel1.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel1.setText("All Sales Info");
    ...
    private void formWindowOpened(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowOpened
        // TODO add your handling code here:
        DefaultTableModel t = (DefaultTableModel) salesInfo.getModel();
        t.addColumn("Medicine ID");
        t.addColumn("Medicine Name");
        t.addColumn("Patient Name");
        t.addColumn("Rate");
        t.addColumn("Quantity");
        t.addColumn("In Stock");
        try {
            DBConnect.connectdb();
            String sql = "SELECT `medicine_ID`, `medicine_name`, `patient_name`,`rate`, `quantity`, `in_stock` FROM `Sales_info` order by medicine_ID DESC LIMIT 0 , 10";
            pst = DBConnect.conn.prepareStatement(sql);
            rs = pst.executeQuery();
            while (rs.next()) {
                t.addRow(new Object[]{
                    rs.getString("medicine_ID"), rs.getString("medicine_name"),
                    rs.getString("patient_name"), rs.getString("rate"),
                    rs.getString("quantity"), rs.getString("in_stock")
                });
            }
        } catch (Exception e) {
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ViewAllSales().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JTable salesInfo;
